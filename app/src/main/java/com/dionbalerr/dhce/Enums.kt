...
object CommandApdu
{
    ...
    val GPO_HEADER = byteArrayOf(0x80.toByte(), 0xA8.toByte(), 0x00, 0x00)
    val READ_RECORD_HEADER = byteArrayOf(0x00.toByte(), 0xB2.toByte())

    val VISA_TTQ = byteArrayOf(0x24, 0x80.toByte(), 0x00, 0x00)

    val DEFAULT_AMOUNT = byteArrayOf(0x00, 0x00, 0x00, 0x00, 0x10, 0x00)
    val COUNTRY_MALAYSIA = byteArrayOf(0x04, 0x58)
}
